                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <textarea type="text" id="description_{{ $lang['code'] }}"
                                                                    ...
                                                                    placeholder="{{ __('Enter Description') }}" value="">{{ $translate[$lang['code']]['description'] ?? $brand['description'] }}</textarea>
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    ...
                                                    <label class="custom-file-label"
                                                        for="exampleInputFile">{{ $brand->thumbnail ?? __('Choose file') }}</label>
                                                </div>
                                            </div>
